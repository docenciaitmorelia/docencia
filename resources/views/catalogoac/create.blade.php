...
<form action="{{ route('catalogoac.store') }}" method="POST">
    ...
    <div class="col-md-6">
        ...
        <input class="form-control" type="text" id="actividad" name="actividad" style="text-transform:uppercase;">
    </div>

    <div class="col-md-6">
        <label class="control-label" for="creditos">Número de créditos</label>
        <input class="form-control" type="number" id="creditos" name="creditos">
    </div>

    <p class="col-md-12 form-group">
        <button type="submit" class="btn btn-raised btn-primary">Guardar</button>
        <button name="cancel" id="cancel" data-toggle="modal" data-target="#modal1" class="btn btn-raised btn-primary">Cancelar</button>
    </p>
